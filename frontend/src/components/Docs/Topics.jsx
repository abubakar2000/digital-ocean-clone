      ...
      {/* <ul>
        ...
        <li data-nav-id="/products/compute/" class="dd-item alwaysopen">
          ...
          <ul>
            ...
            <li
              data-nav-id="/products/app-platform/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/app-platform/">
                  <img
                    src="/images/icons/app-platform.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
            ...
            <li data-nav-id="/products/kubernetes/" class="dd-item alwaysopen">
              <div>
                <Link to="/products/kubernetes/">
                  <img
                    src="/images/icons/kubernetes.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
        ...
        <li data-nav-id="/products/databases/" class="dd-item">
          <div>
            <Link to="/products/databases/">
              <img
                src="/images/icons/databases.svg"
                width="24"
                height="24"
                class="icon"
              />
        ...
        <li data-nav-id="/products/networking/" class="dd-item alwaysopen">
          <div>
            <Link to="/products/networking/">
              <img
                src="/images/icons/networking.svg"
                width="24"
                height="24"
                class="icon"
              />
          ...
          <ul>
            <li
              data-nav-id="/products/networking/dns/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/networking/dns/">
                  <img
                    src="/images/icons/dns.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
            ...
            <li
              data-nav-id="/products/networking/floating-ips/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/networking/floating-ips/">
                  <img
                    src="/images/icons/floating-ips.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
            ...
            <li
              data-nav-id="/products/networking/load-balancers/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/networking/load-balancers/">
                  <img
                    src="/images/icons/load-balancers.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
            ...
            <li
              data-nav-id="/products/networking/firewalls/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/networking/firewalls/">
                  <img
                    src="/images/icons/firewalls.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
            ...
            <li
              data-nav-id="/products/networking/ipv6/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/networking/ipv6/">
                  <img
                    src="/images/icons/ipv6.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
            ...
            <li
              data-nav-id="/products/networking/vpc/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/networking/vpc/">
                  <img
                    src="/images/icons/vpc.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
        ...
        <li data-nav-id="/products/management/" class="dd-item alwaysopen">
          ...
          <ul>
            ...
            <li
              data-nav-id="/products/accounts/teams/"
              class="dd-item alwaysopen"
            >
              <div>
                <Link to="/products/accounts/teams/">
                  <img
                    src="/images/icons/teams.svg"
                    width="24"
                    height="24"
                    class="icon"
                  />
