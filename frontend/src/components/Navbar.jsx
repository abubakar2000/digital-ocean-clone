        ...
        return (
            ...
            <div style={{ height: '117px', display: this.props.display }}>
                ...
                <header className="header" style={{
                    backgroundColor: this.state.isScrollingUp ? "white" : 'rgb(249, 250, 254)', position: this.state.isScrollingUp ? 'fixed' : 'relative',
                    top: 0
                }}>
                    <div className="container" >
                            ...
                            <nav className="nav">
                                <ul>
                                    <li>
                                        ...
                                        }}>Products <FontAwesomeIcon icon={this.state.isProductsOpen ? faAngleUp : faAngleDown} /> </button>
                        ...
                        <div className="dropdown-content bg-light p-2" style={{ display: this.state.isProductsOpen ? 'block' : 'none' }}>
                                ...
                                <div className='col-md-4 bg-light left-side overflow-auto'>
                                    <h5 className='bold mb-5 text-dark'>Featured Products</h5>
                                    {
                                        this.state.products.map(prd => (
                                            prd.sub_products.filter(si => si.featured === true).map(it => (
                                                <div className='card custom-card text-dark'>
                                                    <Link key={it.title + prd.title} className='text-decoration-none text-dark' to="/product">
                                                        <div>
                                                            <h5>{it.title}
                                                            </h5>
                                                            <p>
                        ...
                        <div className="dropdown-content bg-light p-2" style={{ display: this.state.isCommunityOpen ? 'block' : 'none' }}>
                            <div className='row p-4'>
                                <div className='col-md-4 bg-light left-side overflow-auto'>
                                    <h5 className='bold mb-5 text-dark'>Community</h5>
                                    <div className='card custom-card text-dark'>

                                        <Link className='text-decoration-none text-dark' to="/community">
                                            <div>
                                                <h5>Overview</h5>
                                                <p>
                                ...
                                <div className='col-md-7 m-3 mt-5'>
                                    <div className="row">
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <ul>
                                                <li>
                                                    <Link to={"/community/write-for-donations"} className='text-dark text-decoration-none'>Write for Donations</Link>
                                                </li>

                                                <li>
                                                    <Link to={"/community/meetups"} className='text-dark text-decoration-none'>Meetups</Link>
                                                </li>

                                                <li>
                                                    <Link to={"/community/hatch-startup-program"} className='text-dark text-decoration-none'>Hatch Startup Program</Link>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="col-md-8">
                                            ...
                                            <ul>
                                                ...
                                                {
                                                    this.state.articles.filter(art => art.featured === true).map(art => (
                                                        <li>
                                                            <div className="row">
                                                                <div className="col-3">
                                                                    <img src="https://picsum.photos/70" className='rounded-3' style={{ width: '70px', height: '70px' }} alt="" />
                                                                </div>
